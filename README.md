...
This example is very suited to be used with the [Robot Assistants feature of Control Room](https://robocorp.com/docs/product-manuals/robocorp-cloud/using-assistant-robots).
